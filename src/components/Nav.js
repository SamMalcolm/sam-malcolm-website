	...
	return (
		<nav style={{ "backgroundColor": 'black' }}>
			...
			<div className="nav-links" style={{ 'display': (expanded) ? 'block' : 'none' }}>
				<NavLink highlight={props.highlight} name="Work" key="Work" path="/work" showMenu={showMenu} />
				<NavLink highlight={props.highlight} name="Blog" key="Blog" path="/blog" showMenu={showMenu} />
				<NavLink highlight={props.highlight} name="Music" key="Music" path="/music" showMenu={showMenu} />
				{/* <NavLink highlight={props.highlight} name="Tutorials" path="/tutorials" showMenu={showMenu} /> */}
				<NavLink highlight={props.highlight} name="Snooker" key="Snooker" path="/snooker" showMenu={showMenu} />
				<NavLink highlight={props.highlight} name="Film" key="Film" path="/film" showMenu={showMenu} />
				<NavLink highlight={props.highlight} name="About" key="About" path="/about" showMenu={showMenu} />
				<NavLink highlight={props.highlight} name="Live" key="Live" path="/appearances" showMenu={showMenu} />
				<NavLink highlight={props.highlight} name="Contact" key="Contact" path="/contact" showMenu={showMenu} />
			</div>
		</nav>
	)
}
